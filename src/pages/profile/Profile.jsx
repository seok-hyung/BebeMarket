...
import UnfollowButton from '../../components/common/button/button';
import Product from '../../components/common/product/Product';
import HomePostList from '../../components/common/home/HomePost';
  ...
  return (
    <div>
      ...
      <S.PostContainer>
        ...
        <div style={isListMode ? {} : { display: 'none' }}>
          <HomePostList /> {/* 목록형 레이아웃 */}
        </div>
      </S.PostContainer>
      <TabMenu />
    </div>
